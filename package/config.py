...
folders_rules_dict = {
    ...
    "Ингосстрах_Скачано": {
        ...
        "separator_name": "email_by_file_name",
        "file_rules": [
            {"pattern": "^ИГС_ИЗМЕН_", "target_folder": "Ингосстрах_Изменение"},
            {"pattern": "^ИГС_ОТКР_", "target_folder":  "Ингосстрах_Открепление"},
            {"pattern": "^^ИГС_ПРИКР_", "target_folder":  "Ингосстрах_Прикрепление"}            
        ]
    },
    ...
    "Росгосстрах ТЭК_Изменение": {
    },    
    "Росгосстрах ТЭК_Открепление": {
        "processor_name": "rosgosstrah_tek_otkrep"
    },
    "Росгосстрах ТЭК_Прикрепление": {  
        "dict": {
            "По факту: Амбулаторно-поликлиническая помощь": "051.320",
            "По факту: Амбулаторно-поликлиническая помощь; Помощь на дому": "052.320",
            "По факту: Амбулаторно-поликлиническая помощь; Помощь на дому; Стоматология": "053.320",
    ...
    "Росгосстрах ТЭК_Скачано": {
        ...
        "file_rules": [
            {"row": 15, "column": 1, "pattern": "^Просим изменить программу с .*", "target_folder": "Росгосстрах ТЭК_Изменение"},
            {"row": 6, "column": 0, "pattern": ".*просим Вас принять на медицинское обслуживание.*", "target_folder": "Росгосстрах ТЭК_Прикрепление"},            
            {"row": 5, "column": 0, "pattern": ".*просим Вас принять на медицинское обслуживание.*", "target_folder": "Росгосстрах ТЭК_Прикрепление"},
            {"row": 4, "column": 0, "pattern": ".*Просим снять с обслуживания.*", "target_folder": "Росгосстрах ТЭК_Открепление"}
        ]
    },
