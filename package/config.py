...
folders_rules_dict = {
    ...
    "Абсолют_Открепление": {
        ...
        "source_header": [
            "npp", "NAME1", "NAME2", "NAME3", "NIB", "DATE", "SEX", "POLIC", "POLIC SER", "ADDRESS P", "TEL1", "KATEGORY ", "PLACE", "BEGIN", "END"
            ],
        "result_columns": [
    ...
    "Абсолют_Прикрепление": {
        ...
        "source_header": [
            "npp", "NAME1", "NAME2", "NAME3", "DATE", "SEX", "POLIC", "POLIC SER", "ADDRESS P", "TEL1", "KATEGORY ", "PLACE", "BEGIN", "END"
        ],
        "result_columns": [
    ...
    "Абсолют_Скачано": {
        "email_folder": "Абсолют\xa0Страхование",
        "separator_name": "email_by_file_name",
        "file_rules": [
            {"pattern": "\.docx$", "target_folder": "Абсолют_Изменение"},
            {"pattern": "\.png$", "target_folder": "удалён"},
            {"pattern": "\.jpg$", "target_folder": "удалён"},            
            {"pattern": "^.*Принятие.*\.xls$", "target_folder": "Абсолют_Прикрепление"},
            {"pattern": "^.*ПРИНЯТИЕ.*\.xls$", "target_folder": "Абсолют_Прикрепление"},            
            {"pattern": "^.*Снятие.*\.xls$", "target_folder": "Абсолют_Открепление"},
            {"pattern": "^.*СНЯТИЕ.*\.xls$", "target_folder": "Абсолют_Открепление"},
        ]
    },
