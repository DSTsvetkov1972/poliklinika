...
folders_rules_dict = {
    ...
    "ВСК_Скачано": {
        ...
        "file_rules": [
            ...
            {"sheet_name": "", "cell": "A3", "pattern": "Список застрахованных на смену фамилии:$", "target_folder": "ВСК_Изменение"}
            ]
    },
    ...
    "Югория_Скачано": {
        ...
        "file_rules": [
            ...
            {"pattern": "АО_ГСК_Югория_списки_открепление_ГБУЗ_ГП_№_220_ДЗМ_", "target_folder": "Югория_Открепление"}           
        ]
    }
}